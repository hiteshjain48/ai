...
public class MacroP2 {
    public static void main(String[] args) throws Exception {
        BufferedReader irb=new BufferedReader(new FileReader("C:\\Users\\Hitesh\\Desktop\\College\\TE\\SPOS\\Practicals\\intermediate.txt"));
        ...
        while((line=irb.readLine())!=null)
        {
            ...
            if(mnt.containsKey(parts[0]))
            {
                ...
                for(int i=0;i<pp;i++)
                {
                    parts[paramNo]=parts[paramNo].replace(",", ""); aptab.put(paramNo, parts[paramNo]);
